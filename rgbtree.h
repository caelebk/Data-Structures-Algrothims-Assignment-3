...
public:
  ...
  /* nearest neighbor function.                                     */
    ...
    /* distance
       This function finds the distance between two coordinates
    */
    int dist(const RGBAPixel& query, const RGBAPixel& curr) const;

    int findHelper(const RGBAPixel &query, RGBAPixel &nearest, int start, int end, int dimension) const;
};
#endif
